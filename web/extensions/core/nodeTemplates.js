...
const id = "kaonashi.NodeTemplates";
const file = "kaonashi.templates.json";

class ManageTemplates extends kaonashiDialog {
	constructor() {
		super();
		this.load().then((v) => {
			this.templates = v;
		...
		this.element.classList.add("kaonashi-manage-templates");
		this.draggedEl = null;
						...
						$el(
							"div",
							{
								...
								style: {
									...
									gap: "5px",
									backgroundColor: "var(--kaonashi-menu-bg)"
								},
								ondragstart: (e) => {
										...
										$el("input", {
											...
											onchange: (e) => {
												...
												this.saveVisualCue = setTimeout(function () {
													...
													el.style.backgroundColor = 'var(--kaonashi-input-bg)';
												}, 15);
											},
											onkeypress: (e) => {
												var el = e.target;
